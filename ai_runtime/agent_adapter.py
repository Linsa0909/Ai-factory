...
class AgentResult:
    ...
    files_changed: list[str]  # list of modified file paths (populated by PatchEngine)
    tokens_used: int
    model: str
...
class AgentAdapter:
    ...
    async def run(self, task_type: str, prompt: str, context: str, workspace: str) -> AgentResult:
        ...
        return await self._run_deepseek(prompt, context)
    ...
    async def _run_deepseek(self, prompt: str, context: str) -> AgentResult:
